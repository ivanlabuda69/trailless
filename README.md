<div align="center">
  <img src="https://i.ibb.co/cXM6mbNq/photo-2026-06-14-21-27-45.jpg" width="96" style="border-radius: 50%; box-shadow: 0 0 0 2px rgba(255,255,255,0.1);">
  <h1>trailless</h1>
  <p>Чат в стиле тёмной материи</p>
...
| <code>🎁</code> **Подарки** | Система монет и подарков |
| <code>🖱️</code> **Контекстное меню** | Ответить / Редактировать / Удалить |
| <code>✅</code> **Верификация** | Белая галочка в чёрном кружке |
| <code>📱</code> **Мобильные** | Только ПК (заглушка с дизайном) |
